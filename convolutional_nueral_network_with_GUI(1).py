...
#mnist load data loades the all the data we want to access in the progam all the data of the folder is uploaded in the program 
...
# and the loaded images will be showing in the screen as we give the dimensions of the images
...
window.title("Handwriting equation solver by using CNN  ")
